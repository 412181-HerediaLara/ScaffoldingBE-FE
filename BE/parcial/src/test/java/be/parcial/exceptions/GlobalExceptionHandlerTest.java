...
class GlobalExceptionHandlerTest {
    ...
    private MockHttpServletRequest createRequest() {
        ...
        request.setRequestURI("/api/v1/dummies");
        return request;
    }
    ...
    void handleResourceNotFound_returns404() {
        ResourceNotFoundException ex = new ResourceNotFoundException("Dummy not found");
        ...
        assertThat(response.getBody().getMessage()).isEqualTo("Dummy not found");
        assertThat(response.getBody().getPath()).isEqualTo("/api/v1/dummies");
    ...
    void handleValidationErrors_returns400() {
        ...
        FieldError fieldError = new FieldError("dummyRequestDTO", "name", "Name cannot be blank");
