...
class JwtAuthenticationFilterTest {
    ...
    void doFilterInternal_validToken_setsAuthentication() throws ServletException, IOException {
        ...
        when(jwtService.extractUsername("valid-jwt-token")).thenReturn("test@email.com");
    ...
    @Test
    @DisplayName("should not set authentication when email is null")
    ...
    void doFilterInternal_invalidToken_doesNotSetAuthentication() throws ServletException, IOException {
        ...
        when(jwtService.extractUsername("invalid-jwt")).thenReturn("test@email.com");
        when(userDetailsService.loadUserByUsername("test@email.com")).thenReturn(userDetails);
    ...
    void doFilterInternal_alreadyAuthenticated_doesNotReauthenticate() throws ServletException, IOException {
        ...
        request.addHeader("Authorization", "Bearer some-jwt");
        when(jwtService.extractUsername("some-jwt")).thenReturn("test@email.com");
