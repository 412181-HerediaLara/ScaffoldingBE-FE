...
class SecurityIntegrationTest {
    ...
    void authenticate_seededUser_returnsTokens() throws Exception {
        AuthRequestDTO request = new AuthRequestDTO("admin@parcial.com", "admin123");
    ...
    void authenticate_invalidCredentials_returns401() throws Exception {
        AuthRequestDTO request = new AuthRequestDTO("admin@parcial.com", "wrongpassword");
    ...
    void refresh_validToken_returns200() throws Exception {
        AuthRequestDTO authRequest = new AuthRequestDTO("admin@parcial.com", "admin123");
